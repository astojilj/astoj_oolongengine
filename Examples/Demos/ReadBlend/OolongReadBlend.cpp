...
#if __IPHONE_OS_VERSION_MAX_ALLOWED >= 30000 || defined(QT_BUILD)
...
#ifndef __APPLE__
// http://dynamica.googlecode.com/svn/trunk/Demos/BlendParse/BasicDemo.cpp
...
#else
		printf("GfxObject::render error - no rendering.\n");
#endif
	}
